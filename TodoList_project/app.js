...
(function (arrOfTasks) {
  ...
  //6)
  const form = document.forms['addTask']; //<form name="addTask">
  const inputTitle = form.elements['title']; //<input name="title"/>
  const inputBody = form.elements['body']; //<input name="body"/>
